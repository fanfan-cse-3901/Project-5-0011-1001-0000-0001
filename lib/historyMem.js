...
function updateHistory() {
  ...
  for( let i = 0; i < hist.length; i++) {
    ...
    if (i%2 === 0) {
      ...
      //histElement.style.fontWeight='bold';
...
function updateMemory() {
  ...
  // Set memPress back to false so when other operations are done, it only shows history buffer
  memPress.flag = false;
}
