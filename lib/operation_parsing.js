...
let op2 = document.getElementsByName("exp");
let oMod = document.getElementsByName("other")[2];
...
for (let i = 0; i < op.length - 1; i++) {
  op[i].addEventListener("click", binary_op, false);
}
// ^
op2[1].addEventListener("click", binary_op, false);
// logyx
op2[exp.length - 1].addEventListener("click", binary_op, false);
// mod
oMod.addEventListener("click", binary_op, false);