...
document.getElementsByName("delete")[0].addEventListener("click", clearDisplay);
document.getElementsByName("delete")[1].addEventListener("click", clearLower);
...
/* ClearLower clears the lower display. It has no parameters */
function clearLower() {
  display.value = "0";
  displayStr.lower = "";
