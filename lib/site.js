...
// Edited on 07/07/2020 by Yifan Yao: relocate getNum function
// Edited 07/10/2020 by Kevin Dong: Implemented negation
...
function getNum() {
  if (afterCalc) {
    ...
    display.value = displayStr.lower;
  } else if (display.value === "0" || clear || display.value === ERROR) {
    displayStr.lower = this.value;
