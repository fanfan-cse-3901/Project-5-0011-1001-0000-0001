...
document.querySelector('cos').addEventListener("click", cos_func);
document.querySelector('tan').addEventListener("click", tan_func);
document.querySelector('arcsin').addEventListener("click", arcsin_func);
document.querySelector('arccos').addEventListener("click", arccos_func);
document.querySelector('arctan').addEventListener("click", arctan_func);
document.querySelector('x^2').addEventListener("click", sqr_func);
document.querySelector('x^(1/2)').addEventListener("click", sqrt_func);
document.querySelector('1/x').addEventListener("click", inv_func);
document.querySelector('|x|').addEventListener("click", abs_func);
document.querySelector('log').addEventListener("click", log_func);
document.querySelector('ln').addEventListener("click", ln_func);
document.querySelector('pi').addEventListener("click", pi_func);
document.querySelector('e').addEventListener("click", e_func);
document.querySelector('n!').addEventListener("click", fact_func);
document.querySelector('10^x').addEventListener("click", ten_to_x_func);
document.querySelector('e^x').addEventListener("click", e_to_x_func);
document.querySelector('+').addEventListener("click", plus_func);
document.querySelector('-').addEventListener("click", minus_func);
document.querySelector('×').addEventListener("click", multiply_func);
document.querySelector('÷').addEventListener("click", divide_func);
